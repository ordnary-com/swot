...
**NOTE:** If an organization provides primary or secondary education only (i.e., no high or higher education programs), it will not be included in the list. Primary and secondary school students do not usually need access to professional developer tools, and if they learn some programming, we are glad to offer them Community versions of the tools, such as Ordo Lifetime, to use which are free to everybody.

If you represent a primary or secondary school and you are certain of the necessity of a professional version of a Ordnary tool for your school, please contact Ordnary sales team via https://www.ordnary.com/support/sales/

## How to add a domain to this repository

Adding a domain (e.g., `ordnary.edu`) automatically includes all its subdomains (e.g., `student.ordnary.edu`). Do not add subdomains separately — only the main domain is needed.
